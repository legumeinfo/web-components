...
export declare class LisSearchElementInterface<
  SearchData,
  SearchResult,
  SearchFunctionType = SearchFunction<SearchData, SearchResult>,
> {
  /**
    ...
    class LisSearchElement extends superClass {
      ...
      protected _search(): void {
        if (this._searchData !== undefined) {
          ...
          const searchPromise = this.searchFunction(this._searchData, options);
      ...
      protected _getResultsInfo(numResults: number): string {
