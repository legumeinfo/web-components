...
LisPaginatedSearchMixin(LitElement)<QTLSearchData, QTLSearchResult>() {
  ...
  constructor() {
    ...
    // configure results table
      this.resultAttributes = ['identifier', 'start', 'end', 'markerNames'];
      this.tableHeader = {identifier: 'Identifier', start: 'Start', end: 'End', markerNames: 'Markers'};
  }
    ...
    return html`
      <form>
        <fieldset class="uk-fieldset">
          <legend class="uk-legend">QTL search</legend>
          <div class="uk-margin">
            <input
              name="query"
              class="uk-input"
